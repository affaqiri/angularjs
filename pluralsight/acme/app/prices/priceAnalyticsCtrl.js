...
(function () {
    ...
    angular
        ...
        .controller("PriceAnalyticsCtrl",
                    ["$scope", "$filter", "products", "productService",
                     PriceAnalyticsCtrl]);
    ...
    function PriceAnalyticsCtrl($scope, $filter, products, productService) {
        ...
        /**
         * Filter the products to only five products using the built-in $filter filter.
         */
        ...
        /**
         * We need to adapt the data as required by angular-chart
         */
        var chartDataAmount = [];
        ...
        /**
         * Data object needed by the first chart.
         */
        $scope.dataAmount = {
        ...
        /**
         * Configuration object needed by the first chart.
         */
        $scope.configAmount = {
